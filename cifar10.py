...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 28 10:27:40 2020
...
try:
    model.load_weights("Cifar10_CNN_model_2.weight")
...
scores = model.evaluate(test_feature_normalize, test_label_onehot, verbose=1)
print('score : '+scores)

prediction = model.predict_classes(test_feature_normalize)
show_images_labels_predictions(test_feature,test_label,prediction,0,20)

model.save('Cifar10_CNN_model_2.h5')     #將模型儲存至 HDF5檔案中
print("\Cifar10_CNN_model_2.h5 模型儲存完畢!")
model.save_weights("Cifar10_CNN_model_2.weight") # 將參數儲存不含模型
print("模型參數儲存完畢!")
